...
dp.message.register(process_positive_answer, Text(text=['Да', 'Давай', 'Сыграем', 'Игра',
                       'Играть', 'Хочу играть'], ignore_case=True))
dp.message.register(process_negative_answer, Text(text=['Нет', 'Не', 'Не хочу', 'Не буду'],
                                                  ignore_case=True))
dp.message.register(process_other_text_answers)
